...
public class Kassierer implements Serializable {
    ...
    /**
     * Gibt den hinterlegten Startbestand (Wechselgeld) für die Schicht zurück.
     * * @return Der Startbestand als Dezimalwert.
     */
    ...
    /**
     * Setzt den Startbestand (Wechselgeld) für den aktuellen Kassenlauf.
     * * @param startBestand Der einzubuchende Startbestand.
     */
    ...
    /**
     * Prüft, ob der Kassierer über Manager-Rechte verfügt.
     * * @return true, falls er Manager ist, sonst false.
     */
    public boolean isManager() { return isManager; }

    /**
     * Weist dem Kassierer Manager-Rechte zu oder entzieht ihm diese.
     * * @param manager true, um ihn zum Manager zu machen, false andernfalls.
     */
